                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <div class="user_setting_content">
                        ...
                        <a class="dropdown-item" href="page-dashboard-proposal.html"><i class="flaticon-document mr10"></i>Projects</a>
                        <a class="dropdown-item" href="page-dashboard-save.html"><i class="flaticon-like mr10"></i>Repositories</a>
                        <a class="dropdown-item" href="page-dashboard-message.html"><i class="flaticon-chat mr10"></i>Message</a>
                        <a class="dropdown-item" href="page-dashboard-reviews.html"><i class="flaticon-review-1 mr10"></i>Personal Info</a>
                        <a class="dropdown-item" href="page-dashboard-invoice.html"><i class="flaticon-receipt mr10"></i>Academics</a>
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="page-dashboard-reviews.html" class="items-center"><i class="flaticon-review-1 mr15"></i>Personal Info</a>
          </div>
          <div class="sidebar_list_item">

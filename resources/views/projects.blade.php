...
<head>
  ...
  <div class="body_content">
    ...
    <section class="breadcumb-section pt-0">
      <div class="cta-service-v1 cta-banner mx-auto maxw1700 pt120 pb120 bdrs16 position-relative overflow-hidden d-flex align-items-center mx20-lg px30-lg" style="background-image: url(https://content.cdntwrk.com/files/aHViPTg1NDMzJmNtZD1pdGVtZWRpdG9yaW1hZ2UmZmlsZW5hbWU9aXRlbWVkaXRvcmltYWdlXzVlMGY5N2UzODJhNjYuanBnJnZlcnNpb249MDAwMCZzaWc9YTg0YmNkNzBmOWJlMTE5YjhkNTJkYTM3ZDk0ZThmODU%253D);">
        <img class="left-top-img wow zoomIn" src="images/vector-img/left-top.png" alt="">
        <img class="right-bottom-img wow zoomIn" src="images/vector-img/right-bottom.png" alt="">
        <img class="service-v1-vector bounce-y d-none d-lg-block" src="https://cdn-blog.adafruit.com/uploads/2021/06/Untitled-151.jpg" style="border-radius: 25px;"alt="">
        <div class="container">
          <div class="row wow fadeInUp">
            <div class="col-xl-5">
              <div class="position-relative">
                <h2 style="color:white; text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;">Projects</h2>
                <p style="color:white;" class="text mb-0">Find all the projects that can match with your skill.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-sm-6 col-xl-4">
                <div class="freelancer-style1 text-center bdr1 hover-box-shadow">
                  ...
                  <div class="details">
                    <h5 class="title mb-1">Research Title  </h5>
                    <p class="mb-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit inventore, alias sapiente beatae tempora delectus! Officia asperiores ex, accusantium eos maxime iure repellat possimus dolor, quibusdam eius necessitatibus laudantium quae?</p>
                    <div class="skill-tags d-flex align-items-center justify-content-center mb5">
                     <a href=""><span class="tag">Figma</span></a>
                     <a href=""><span class="tag mx10">Sketch</span></a>
                     <a href=""><span class="tag">HTML5</span></a>
                    </div>
                    <hr class="opacity-100 mt20 mb15">
                   
                    <div class="d-grid mt15">
                      <a href="single.html" class="ud-btn btn-light-thm">See more<i class="fal fa-arrow-right-long"></i></a>
                    </div>
                  </div>
                </div>
              </div>
